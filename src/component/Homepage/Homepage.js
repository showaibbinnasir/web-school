...
const Homepage = () => {
    ...
    return (
        <div className='text-center mt-5'>
            <h1 data-aos="zoom-in-down" className='text-2xl font-semibold'>Welcome to the <br /><span className='text-4xl'>Web-<span className='text-yellow-300'>School</span></span></h1>
            <div className='banner mt-5' data-aos="zoom-in-down">
                    <div>
